...
//ENABLE_MPU_OVERFLOW_PROTECTION();		                        // activa proteccion y evita problemas con monitor serial, ya no se requiere

// #define OFFSETS  -5114,     484,    1030,      46,     -14,       6  // Colocar valores personalizados (indican posición inicial)
...
// mostrar_valores funcion que es llamada cada vez que hay datos disponibles desde el sensor por la interrupcion
...
#if I2CDEV_IMPLEMENTATION == I2CDEV_ARDUINO_WIRE	// activacion de bus I2C a 400 Khz (parametro de velocidad)
  Wire.begin();
